            ...
            __html: `
              (function() {
                if (typeof window !== 'undefined') {
                  // Implementação completa de btoa que suporta UTF-8
                  window.btoa = function(str) {
                    // Primeiro converte UTF-8 para Latin1 usando encodeURIComponent
                  ...
                  console.log('[btoa] Implementação UTF-8 ativada');
                }
              })();
            `,
          }}
